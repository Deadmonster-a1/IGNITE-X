...
export default function JavaIntermediateDocsLayout() {
          ...
          <div className="p-4 border-t border-[#a855f7]/20 bg-[#0f071a] shrink-0">
            <div className="flex flex-col gap-2">
               <div className="flex items-center justify-between">
                 ...
                 <span className="font-mono text-[9px] text-[#a855f7]">1.2GB / 8GB</span>
               </div>
               <div className="w-full bg-black h-1.5 rounded-full overflow-hidden">
                 <div className="bg-[#a855f7] h-full w-[45%] animate-pulse" />
               </div>
               <div className="flex items-center gap-2 mt-1">
                 <div className="w-1.5 h-1.5 rounded-full bg-yellow-500 animate-pulse" />
                 <span className="font-mono text-[8px] uppercase tracking-widest text-white/40">Garbage Collector: Executing...</span>
               </div>
            </div>
          </div>
        </aside>
        ...
        <main className="flex-1 relative z-10 flex flex-col bg-transparent overflow-y-auto custom-scrollbar pt-14 lg:pt-0">
           ...
           <header className="hidden lg:flex h-14 border-b border-[#a855f7]/10 items-center justify-between px-8 sticky top-0 bg-[#0c0614]/80 backdrop-blur-md z-30">
              <div className="flex items-center gap-2 text-[11px] font-mono text-white/40 uppercase tracking-wider truncate max-w-lg">
                 ...
                 <span className="text-[#a855f7]">::</span>
                 <span className="text-[#a855f7] shrink-0">Node.java</span>
              </div>
              ...
              <div className="flex items-center gap-4 shrink-0">
                 <div className="flex items-center gap-2 px-3 py-1 rounded-md border border-[#a855f7]/30 bg-[#a855f7]/10">
                   ...
                   <span className="font-mono text-[10px] font-bold text-[#a855f7]">12,450 XP</span>
                 </div>
                 <div className="flex items-center gap-2 px-3 py-1 rounded-md border border-white/10 bg-black">
                   <Zap size={12} className="text-yellow-500" />
                   <span className="font-mono text-[10px] font-bold text-white">4 Day Streak</span>
                 </div>
              </div>
           </header>
                ...
                >
                   ...
                   <div className="space-y-6">
                      <div className="flex items-center gap-5">
                          ...
                          <div>
                              <span className="font-mono text-[11px] uppercase tracking-[0.2em] font-black block mb-1 text-[#a855f7]">
                                {activeLesson.type === 'concept' ? 'public abstract class' : 'public interface'} {activeLesson.title.replace(/ /g, '')}
                              </span>
                      ...
                      <div className="flex flex-wrap gap-2 pt-2">
                          ...
                          <span className="px-3 py-1 text-[10px] font-mono font-bold uppercase rounded-full border border-[#a855f7]/40 bg-[#a855f7]/10 text-[#c084fc]">
                              +{activeLesson.xpReward || (activeLesson.type === 'concept' ? 100 : 250)} XP Return
                          </span>
                   ...
                   <div className="p-6 border border-[#a855f7]/20 bg-[#a855f7]/5 rounded-xl relative overflow-hidden">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <p className="font-mono text-xs text-[#a855f7] mb-2">/** Architecture Summary */</p>
                   ...
                   {activeLesson.code && (
                     <div className="mt-12 space-y-4 animate-[fadeInUp_0.6s_ease-out_0.2s_both]">
                       <h3 className="text-sm font-black uppercase tracking-widest text-white flex items-center gap-2">
                         ...
                         {activeLesson.type === 'concept' ? 'Implementation.java' : 'Task.java'}
                       </h3>
                         ...
                         <pre className="p-6 text-[13px] sm:text-sm font-mono text-[#d4d4d4] overflow-x-auto whitespace-pre-wrap leading-relaxed custom-scrollbar">
                           <code dangerouslySetInnerHTML={{
                             ...
                             __html: activeLesson.code
                               .replace(/\b(public|private|protected|class|static|void|int|double|boolean|char|if|else|switch|case|break|continue|for|while|do|return|import|new|extends|implements|override|@Override)\b/g, "<span class='text-[#c678dd]'>$1</span>")
                               .replace(/\b(String|System|Scanner|StringBuilder|Math|ArrayList|HashMap|Map|List|Node|MyClass)\b/g, "<span class='text-[#e5c07b]'>$1</span>")
                               .replace(/(".*?")/g, "<span class='text-[#98c379]'>$1</span>")
                               .replace(/(\/\/.*)/g, "<span class='text-[#5c6370] italic'>$1</span>")
                               .replace(/([A-Z][a-zA-Z0-9_]*)/g, (match, p1) => {
                                  if (['String', 'System', 'Scanner', 'StringBuilder', 'Math', 'ArrayList', 'HashMap', 'Map', 'List', 'Node', 'MyClass'].includes(p1)) return match;
                   ...
                   <div className="pt-12 mt-12 border-t border-white/10 flex flex-col sm:flex-row gap-6 items-center justify-between animate-[fadeInUp_0.6s_ease-out_0.4s_both]">
                     <div className="flex flex-col text-center sm:text-left">
                       <span className="text-[10px] font-mono text-white/40 uppercase tracking-widest mb-1">Compiler Sequence Ready</span>
                       <span className="font-bold text-lg text-white">Execute Architectural Simulation</span>
                     </div>
                     <button 
                     ...
                     >
                       ...
                       <span className="relative z-10">Compile & Execute</span>
                     </button>
                   </div>
                </motion.div>
              </AnimatePresence>

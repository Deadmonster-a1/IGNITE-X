...
import { Braces, BookOpen, ChevronRight, Terminal, Target, Zap, TrendingUp, Sparkles } from "lucide-react"
        ...
        <main className="min-h-screen bg-background text-foreground">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        ...
                        <div className="flex-1 text-center lg:text-left animate-[fadeInUp_0.8s_ease-out]">
                            ...
                            <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 border border-accent/30 bg-accent/10 text-accent font-mono text-xs font-bold uppercase tracking-widest"
                                ...
                                Free Course • {courseInfo.totalLessons} Lessons
                            </div>

                            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black tracking-tight leading-[1.05]">
                                <span className="text-foreground">DSA for</span>
                                <br />
                                <span className="relative inline-block mt-2">
                                    <span className="bg-gradient-to-r from-accent via-[#f59e0b] to-accent bg-clip-text text-transparent">
                                        Beginners
                                    </span>
                            ...
                            <div className="mt-10 flex flex-wrap items-center gap-4 justify-center lg:justify-start">
                                <Link
                                    ...
                                    className="group relative flex items-center gap-3 bg-accent px-8 py-4 text-sm font-black uppercase tracking-widest text-[#050505] transition-all hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(242,103,34,0.3)]"
                        ...
                        <div className="w-full max-w-sm lg:max-w-md animate-[fadeInRight_0.8s_ease-out_0.3s_both]">
                            <div className="relative border border-border bg-card/60 backdrop-blur-xl overflow-hidden">
                                ...
                                <div className="absolute -left-10 -bottom-10 h-24 w-24 bg-[#f59e0b]/10 blur-[50px] rounded-full" />
                                ...
                                <div className="border-b border-border/50 bg-secondary/30 px-6 py-4">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <span className="font-mono text-[10px] text-accent uppercase tracking-widest block">Chapter 01</span>
                                                <span className="text-sm font-bold text-foreground">Thinking Like a Programmer</span>
                                            </div>
                                        </div>
                                ...
                                <div className="grid grid-cols-2 gap-[1px] bg-border/30">
                                    {[
                                        { icon: BookOpen, label: "Lessons", value: chapterInfo.totalLessons.toString(), color: "text-accent" },
                                        { icon: Target, label: "Difficulty", value: chapterInfo.difficulty, color: "text-success" },
                                        { icon: Zap, label: "XP Reward", value: `${chapterInfo.xpReward} XP`, color: "text-[#f59e0b]" },
                                        { icon: TrendingUp, label: "Duration", value: chapterInfo.estimatedTime, color: "text-info" },
                                    ].map((stat, i) => (
                                ...
                                <div className="px-6 py-4 border-t border-border/30">
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {["Algorithms", "Pseudocode", "Flowcharts", "Input/Output", "Constraints", "Problem Solving"].map(tag => (
                                ...
                                {/* Bottom accent */}
                                <div className="h-1 w-full bg-gradient-to-r from-accent via-[#f59e0b] to-accent" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-7xl px-5 lg:px-8">
                    <div className="mb-12 text-center">
                        ...
                        <h2 className="text-3xl font-black tracking-tight text-foreground sm:text-4xl">
                            {courseInfo.totalLessons} Lessons across {courseCurriculum[0].chapters.length} Chapters
                        </h2>
                    </div>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        {courseCurriculum[0].chapters.map((chapter, i) => (
                            ...
                            >
                                ...
                                <h3 className="text-lg font-bold text-foreground mb-3 leading-tight">{chapter.title}</h3>
                                <p className="text-xs text-muted-foreground leading-relaxed line-clamp-2 flex-1">
                                    {chapter.concepts.length} Concepts • {chapter.problems.length} Practice Problems
                                </p>
            ...
            <section className="relative py-20 border-t border-border bg-background">
                <div className="mx-auto max-w-4xl px-5 text-center">
                    <h2 className="text-3xl lg:text-5xl font-black tracking-tight mb-6">Ready to Master the Fundamentals?</h2>
                    <p className="text-muted-foreground text-lg mb-10 max-w-2xl mx-auto">
                        Jump into Chapter 1 and start thinking like a true architect. The course is entirely free and requires no sign-up.
                    </p>
                    <Link
                        href="/programs/dsa/course"
                        className="inline-flex items-center gap-3 bg-accent px-10 py-5 text-sm font-black uppercase tracking-widest text-[#050505] transition-all hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(242,103,34,0.4)]"
